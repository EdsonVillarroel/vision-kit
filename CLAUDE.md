...
**Deployment:**
- Backend: imagen GHCR → **Cloud Run** (recomendado, mismo GCP project `vision2020-8df81` que Firebase; escala a 0; `env.yaml` con secretos, ignorado por git). Alternativas: Railway/Render/Fly.io. Healthcheck `/api/v1/health`. Ver `docs/DEPLOYMENT.md` §3.
