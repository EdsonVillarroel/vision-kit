...
async function main() {
  ...
  const patientsData = [
    {
      identificationId: '6543210',
      firstName: 'Ana',
      lastName: 'Mamani Choque',
      dateOfBirth: new Date('1985-05-15'),
      gender: 'female' as const,
      phone: '+591 71234567',
      email: 'ana.mamani@email.com',
      address: 'Av. 6 de Agosto Nº 2456',
      city: 'La Paz',
      state: 'La Paz',
      zipCode: '0000',
    ...
    {
      identificationId: '4567890',
      firstName: 'Roberto',
      lastName: 'Gutiérrez Rojas',
      dateOfBirth: new Date('1972-11-30'),
      gender: 'male' as const,
      phone: '+591 72345678',
      email: 'roberto.gutierrez@email.com',
      address: 'Calle Comercio Nº 789',
      city: 'La Paz',
      state: 'La Paz',
      zipCode: '0000',
      ...
      insurance: {
        provider: 'Caja Nacional de Salud',
        policyNumber: 'CNS-789456',
        groupNumber: 'GRP-001',
      },
    },
    {
      identificationId: '7890123',
      firstName: 'Sofía',
      lastName: 'Villarroel Terán',
      dateOfBirth: new Date('1995-03-20'),
      gender: 'female' as const,
      phone: '+591 73456789',
      email: 'sofia.villarroel@email.com',
    ...
    },
    {
      ...
      insurance: {
        ...
        policyNumber: 'BIS-321654',
      },
    },
    {
      identificationId: '8901234',
      firstName: 'Carmen',
  ...
  const productsData = [
    {
      ...
      supplier: {
        name: 'Distribuidora Óptica La Paz',
        contact: 'Ventas',
        email: 'ventas@distriopticalapaz.com.bo',
        phone: '+591 2 244 0011',
      },
    },
    {
      sku: 'ARZ-OAK-001',
    ...
    },
    {
      ...
      supplier: {
        ...
        email: 'bolivia@essilor.com',
        phone: '+591 2 277 8899',
      },
    },
    {
      sku: 'LENT-MON-001',
    ...
    },
    {
      ...
      supplier: {
        name: 'Johnson & Johnson Bolivia',
        email: 'optica.bolivia@jnj.com',
        phone: '+591 2 211 5566',
      },
    },
    {
      sku: 'SOL-RB-001',
    ...
    },
    {
      ...
      minStock: 20,
      supplier: {
        name: 'Accesorios Ópticos Bolivia',
    ...
    },
    {
      ...
      supplier: {
        name: 'Alcon Cono Sur',
        email: 'ventas.bolivia@alcon.com',
        phone: '+591 2 277 3344',
      },
    },
  ];
